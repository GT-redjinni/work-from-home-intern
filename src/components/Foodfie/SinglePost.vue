  ...
  <div class="mt-3 text-start">
    <form class="w-100 text-start mt-3">
        ...
        <p class="text-desc mt-0 grey-color font-400">Digital Marketing | Social Media
          <br>
          <span style="color: #8A8A8A;font-weight: 400;">when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</span></p>
    </div>
    </form>  
    <form class="w-100 text-start mt-3">
        ...
        <p class="text-desc grey-color font-400 mt-0pt-0">Digital Marketing | Social Media
          <br>
          <span style="color: #8A8A8A;padding-top: 1px;font-weight: 400;">when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</span></p>
    </div>
    </form>  
    <form class="w-100 text-start mt-3">
...
<script>
    export default {
        ...
        data() {
        return {
            activeTab: 'changePass', // Set the default active tab
        };
    },
    methods: {
        showContent(tab) {
