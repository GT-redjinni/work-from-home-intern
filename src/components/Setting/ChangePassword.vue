<template>
    <div class="card">
        <div class="card-header bg-white border-2">
            <div class="heading text-subheading grey-color font-600 ms-3 p-2">Change Password</div>
        </div>
        <div class="card-body mb-2">
            ...
            <div>
                <form class="form-control border-0" style="padding: 10px 30px 10px 30px;">
                    ...
                    <button class="btn confirm-btn text-white w-100 text-center mt-3">RESET PASSWORD</button>
                </form>
            </div>
