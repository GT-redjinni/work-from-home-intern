<template>
    <div class="card">
                    <div class="card-body">
                        <div class="heading ms-3">Change Password</div>
                        <div class="body text-center border-top mt-3">
                            <img src="../../assets/cp-logo.png" alt="" height="150px" width="150px">
                            <br>
                            <p style="padding: 20px 75px 10px 75px;">Lorem ipsum dolor sit amet consectetur adipisicing elit. At quasi vel esse saepe officia odit excepturi dicta voluptatem, mollitia voluptas culpa</p>
                        </div>
                        <div>
                            <form class="form-control border-0" style="padding: 10px 50px 10px 50px;">
                                ...
                                <div class="input-group mb-3 border-bottom border-danger">
                                    <input type="text" class="form-control" placeholder="Current Password" style="border: none;">
                                </div>
                                ...
                                <div class="input-group mb-3 border-bottom border-dark">
                                    <input type="password" class="form-control" placeholder="Confirm Password" style="border: none;">
                                    <button class="btn p-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-eye-slash" viewBox="0 0 16 16">
                                        <path d="M13.359 11.238C15.06 9.72 16 8 16 8s-3-5.5-8-5.5a7 7 0 0 0-2.79.588l.77.771A6 6 0 0 1 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13 13 0 0 1 14.828 8q-.086.13-.195.288c-.335.48-.83 1.12-1.465 1.755q-.247.248-.517.486z"/>
                                        <path d="M11.297 9.176a3.5 3.5 0 0 0-4.474-4.474l.823.823a2.5 2.5 0 0 1 2.829 2.829zm-2.943 1.299.822.822a3.5 3.5 0 0 1-4.474-4.474l.823.823a2.5 2.5 0 0 0 2.829 2.829"/>
                                ...
                                <button class="btn frm-btn text-white w-100 text-center mt-3">RESET PASSWORD</button>
                            </form>
                        </div>
