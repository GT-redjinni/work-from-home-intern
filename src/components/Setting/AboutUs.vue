<template>
    <div class="card">
        <div class="card-header bg-white border-2">
            <div class="heading text-subheading grey-color font-600 ms-3 p-2">About Us</div>
        </div>
        <div class="card-body">
            <div class="body text-center mt-3">
                ...
                <p style="padding: 20px 40px 10px 40px;text-align: start;">
                    ...
                    consectetur ac. Aenean pellentesque consectetur condimentum. Phasellus malesuada luctus libero, sit
                    amet iaculis arcu. Donec eu ante dapibus, euismod ligula et, facilisis dolor. Duis dapibus mi sed
                    magna molestie volutpat. Quisque rutrum condimentum lorem eget gravida. Sed ac fringilla sapien.
                    Suspendisse eleifend mi elementum leo feugiat feugiat.
                </p>
            </div>
        </div>
    </div>
