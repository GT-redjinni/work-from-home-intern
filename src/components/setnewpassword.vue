<template>
    <div class="main-container w-full">
        <div class="sm:row1 w-full px-2">
            <div class="text">
                <div class="row">
                    <div class="col-lg-12" id="second-col">
                        <h2>Set New Password</h2>
                        <p class="p-1">Please enter the new password</p>
                        ...
                        <router-link :to="{ path: '/login' }" custom v-slot="{ navigate }">
                            <button class="submit-btn" @click="navigate, changepassword()" role="link"
        ...
        <div class="col-lg-6 hidden sm:block" id="right-side">
